...
func New() *Backend {
	return &Backend{DeviceList: []backend.Device{{ID: "phone", Name: "Fixture phone", Connected: true, SMSCapability: "available"}}, History: map[string][]domain.Message{}, subs: map[chan domain.Event]context.Context{}}
}
